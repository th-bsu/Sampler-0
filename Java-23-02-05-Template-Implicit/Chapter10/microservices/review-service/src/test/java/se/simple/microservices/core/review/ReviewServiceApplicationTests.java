...
// TH: helps create in-memory database, for rapid-prototyping (i.e. may NOT persist data or changes to data).
// TH: http://www.h2database.com/html/features.html
@RunWith(SpringRunner.class)
@SpringBootTest(webEnvironment=RANDOM_PORT, properties = {
	"logging.level.se.simple=DEBUG",
