package se.simple.microservices.core.review;
...
import se.simple.microservices.core.review.persistence.ReviewEntity;
import se.simple.microservices.core.review.persistence.ReviewRepository;
...
// TH: helps focus only on JPA component testing (i.e. full auto-configuration disabled).
// TH: helps suspend current transaction if one exists.
